      ...
      {isLoading && (
        ...
        >
          ...
          <div className="absolute inset-0 w-screen h-screen">
            {block.backgroundMedia.mediaType === 'image' && block.backgroundMedia.image && (
              <Image
                src={urlFor(block.backgroundMedia.image).url()}
                alt={block.backgroundMedia.image.alt || 'Background'}
                fill
            ...
            {block.backgroundMedia.mediaType === 'video' && block.backgroundMedia.video && (
              <video
                ...
                playsInline
              >
                <source src={block.backgroundMedia.video.asset.url || ''} type="video/mp4" />
              </video>
            )}
          </div>
